...
// This file is inside /smplfy-core/ so we do NOT append smplfy-core again
...
/** 🔹 4. Register GravityPDF Template **/
add_filter('gravitypdf_template_paths', __NAMESPACE__ . '\\smplfy_register_pdf_templates');

function smplfy_register_pdf_templates($paths) {
    $paths[] = SMP_CORE_PLUGIN_DIR . 'pdf-templates/';
    return $paths;
}
